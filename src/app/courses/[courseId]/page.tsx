...
const CourseDetailPage = () => {
  ...
  useEffect(() => {
    const courseData = searchParams.get('course');
    if (courseData) {
      try {
  ...
  const totalLessons = course?.modules ? course.modules.reduce((acc, module) => acc + module.lessons.length, 0) : 0;
  const completedLessons = course?.modules ? course.modules.reduce((acc, module) =>
              ...
              <Card className="bg-slate-800 border-slate-700 sticky top-8">
                ...
                <CardContent className="p-6">
                  ...
                  {course?.enrolled ? (
                    ...
                    <div className="space-y-4">
                      <Button className="w-full bg-blue-600 hover:bg-blue-700" style={{ backgroundColor: '#3b82f6' }}>
                        Enroll Now
                      </Button>
